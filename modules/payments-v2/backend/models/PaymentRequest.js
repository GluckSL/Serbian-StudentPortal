...
const paymentRequestSchema = new mongoose.Schema({
  ...
  paymentType: { type: String, enum: ['Monthly Fee', 'Registration', 'Custom', 'Exam Fee', 'Other', 'LANGUAGE_FEE', 'DOCS_PAYMENT', 'VISA_PAYMENT', 'CUSTOM_PAYMENT'], required: true },
  customType: String,
  source: { type: String, default: null },
  isImported: { type: Boolean, default: false },
  legacyImportedAt: { type: Date },
  legacyImportedBy: { type: mongoose.Schema.Types.ObjectId, ref: 'User' },
