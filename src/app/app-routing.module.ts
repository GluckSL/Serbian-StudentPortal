...
export const routes: Routes = [
  ...
  { path: 'admin/batch-management', loadComponent: () => import('./components/admin-dashboard/batch-management/batch-management.component').then(m => m.BatchManagementComponent), canActivate: [AuthGuard, RoleGuard], data: { role: ['ADMIN', 'TEACHER_ADMIN'] } },
