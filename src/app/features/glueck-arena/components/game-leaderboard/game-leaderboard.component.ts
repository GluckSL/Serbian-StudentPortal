    ...
    <div class="lb">
      <div class="lb__header">
        ...
        <div>
          ...
          <p>Pogledajte svoj plasman u odnosu na druge učenike</p>
        </div>
      </div>
        ...
        <div class="lb__right-card">
          ...
          <div class="lb__list" *ngIf="!loading">
            ...
            <div *ngIf="leaderboard.length === 0" class="lb__empty">
              ...
              <p *ngIf="!(periodLabel === 'all' && myStats?.gamesCompleted)">Još nema završenih igara u ovom periodu. Odigrajte igru da biste se pojavili ovde!</p>
            </div>
          </div>
