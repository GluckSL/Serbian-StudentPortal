...
@Component({
  ...
  `,
  styles: [`
    .bfchat { display: flex; flex-direction: column; min-height: 500px; background: #fff; overflow: hidden; box-shadow: 0 2px 12px rgba(0,0,0,.06); border: 1px solid #e8ecf0; }
    ...
    .bfchat__messages { flex: 1; overflow-y: auto; padding: 12px; display: flex; flex-direction: column; gap: 8px; min-height: 100px; max-height: 400px; }
    ...
    .bfchat__send { width: 36px !important; height: 36px !important; display: flex; align-items: center; justify-content: center; }
    .bfchat__send mat-icon { font-size: 18px; line-height: 1; }
  `]
})
